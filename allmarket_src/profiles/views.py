...
from allmarket.utils import Mailchimp, CsrfExemptMixin
...
class WishlistView(LoginRequiredMixin, ListView):
    template_name = "profiles/user_wishlist.html"
    model = UserProfile
    paginate_by = 10
...
class MarketingPreferenceUpdateView(SuccessMessageMixin, UpdateView):
    ...
    template_name = 'profiles/user_email_marketing.html' # yeah create this
